                    ...
                    <div class="form-content">
                        ...
                        <div class="form-row">
                            <div class="form-holder">
                                <input type="text" placeholder="Nama depan" name="firstname" value="{$firstname}" class="form-control">
                            </div>
                            <div class="form-holder">
                                <input type="text" placeholder="Nama belakang" name="lastname" value="{$lastname}" class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-holder">
                            ...
                            <div class="form-holder">
                                <input type="text" placeholder="Telepon" name="phonenumber" value="{$phonenumber}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-holder">
                                <input type="text" placeholder="Umur" name="age" value="{$age}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control">
                            </div>
                            <div class="form-holder" style="align-self: flex-end; transform: translateY(4px);">
                                <div class="checkbox-tick">
                                    <label class="male">
                                        <input type="radio" name="gender" value="male" {if $gender == "male"} checked {/if}> Pria
                                        <br>
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="female">
                                        <input type="radio" name="gender" value="female" {if $gender == "female"} checked {/if}> Wanita
                                        <br>
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="both">
                                        <input type="radio" name="gender" value="other" {if $gender == "other"} checked {/if}> Lainnya
                                        <br>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                        ...
                        <div class="form-row buttons">
                            <ul>
                                <li style="display: none;">
                                    <a href="#previous" class="backward">Backward</a>
                                </li>
                                <li>
                                    <a href="#next" class="forward register">Forward</a>
                                </li>
                                <li style="display: none;">
                                    <a href="#finish" class="finish">Submit</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="form-row buttons">
                            ...
                            <ul>
                                ...
                                <li {if $smarty.foreach.foo2.last} style="display: none;" {/if}>
                                    <a href="#next" class="forward sub" data-conid="{$con.id_concern}">Forward</a>
                                </li>
                                <li {if not $smarty.foreach.foo2.last} style="display: none; {/if}">
                                    <a href="#finish" class="finish" data-conid="{$con.id_concern}">Submit</a>
                                </li>
                            </ul>
                        </div>
                    </div>
