		...
		t = function () {
			var e = function () {
				if (0 != $("#m_chart_personal_income_quater_4").length) {
					var dataprocessing = $(".quater_4 .processing").attr("data-processing");
					var dataexpired = $(".quater_4 .expired").attr("data-expired");
					...
					case "#m_personal_income_quater_2":
						! function () {
							if (0 != $("#m_chart_personal_income_quater_2").length) {
								var dataprocessing = $(".quater_2 .processing").attr("data-processing");
								var dataexpired = $(".quater_2 .expired").attr("data-expired");
					...
					case "#m_personal_income_quater_3":
						! function () {
							if (0 != $("#m_chart_personal_income_quater_3").length) {
								var dataprocessing = $(".quater_3 .processing").attr("data-processing");
								var dataexpired = $(".quater_3 .expired").attr("data-expired");
					...
					case "#m_personal_income_quater_1":
						! function () {
							if (0 != $("#m_chart_personal_income_quater_1").length) {
								var dataprocessing = $(".quater_1 .processing").attr("data-processing");
								var dataexpired = $(".quater_1 .expired").attr("data-expired");
