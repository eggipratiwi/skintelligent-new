                     ...
                     <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                           ...
                           <li class="m-nav__item">
                              <a href="{$base_url}brands/best-selling" class="m-nav__link">
                           ...
                           <li class="m-nav__item">
                              ...
                              <span class="m-nav__link-text">{$url1|capitalize|replace:"-":" "}</span>
                              </a>
                           </li>
                        </ul>
                     </div>
               ...
               <div class="m-content">
                  <div class="m-portlet m-portlet--mobile">
                     ...
                     <div class="m-portlet__body">
                        ...
                        <!--begin: Datatable -->
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="data-brand">
                           <thead>
                              <tr>
                                 <th>No</th>
                                 <th>Brand Name</th>
                                 ...
                                 <th>Qty all product</th>
                                 <th>Product Sold</th>
                                 <th>Action</th>
                              </tr>
                           </thead>
                           <tbody>
                              {foreach from=$rsBrands item=row name=foo}
                              <tr>
                                 <td>{$smarty.foreach.foo.iteration}</td>
                                 <td>{$row.brand|capitalize}</td>
                                 <td>{if $row.logo != ''}<img src="{$img_url}img/brands/{$row.logo}" height="40">{/if}</td>
                                 <td>{$row.total_type}</td>
                                 <td>{$row.total_qty} pcs</td>
                                 <td>{$row.jml_sales} pcs</td>
                                 <td><a href="/bnbreporting/products/all-product/brands/{$row.brand|lower|replace:' ':'-'}" target="_blank"><i class="flaticon-eye"></i> View Product</a><br><a href="/bnbreporting/products/sold-product/brands/{$row.brand|lower|replace:' ':'-'}" target="_blank"><i class="flaticon-eye"></i> View Penjualan</a></td>
                              </tr>
                              {foreachelse}
                              <tr>
                 ...
                 var t;
                  t = $("#data-brand").DataTable({
                        ...
                        buttons: ["print", "copyHtml5", "excelHtml5", "csvHtml5", {
                           extend: 'pdfHtml5',
                           orientation: 'potrait',
                           title: "Birds And Bees | List Of Brands {/literal}{$url1|replace:'-':' '|capitalize}{literal}",
                           filename: "Birdsnbees Brands {/literal}{$url1|replace:'-':' '|capitalize}{literal}",
