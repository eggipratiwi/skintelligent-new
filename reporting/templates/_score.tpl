                     ...
                     <div class="mr-auto">
                        ...
                        <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                           ...
                           <li class="m-nav__item">
                              <a href="{$base_url}master-data/score" class="m-nav__link">
                           ...
                           <li class="m-nav__item">
                              <a href="{$base_url}master-data/score" class="m-nav__link">
                              <span class="m-nav__link-text">Score</span>
                              </a>
                           </li>
                        </ul>
                     </div>
             ...
             init: function() {
                 var t;
                  t = $("#data-score").DataTable({
                        ...
                        processing: !0,
                        serverSide: !0,
                        ajax: "{/literal}{$base_url}_score-data.php?flag={$url2}{literal}",
